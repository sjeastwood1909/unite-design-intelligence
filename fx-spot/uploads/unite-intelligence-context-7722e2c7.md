...
**Version:** 2.7  **Owner:** Stuart  **Organisation:** Unite  
...
This file is one of two core context documents. Load both for full coverage.
...
**Quick rule:** If you're generating a new workspace or need to look up which pattern applies to a use case, load `unite-reference-patterns.md` alongside this file. If you're generating a single component, tile, or spec, this file alone is sufficient.
...
*Unite Design Intelligence OS — Context File v2.7 — June 2026*
